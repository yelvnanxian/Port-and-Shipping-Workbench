...
export const CARRIER_RULES: CarrierRule[] = [
  ...
  { prefix: 'WHLC', code: 'WANHAI', name: '万海', removePrefix: true, queryMode: 'bill-or-container', url: 'https://cn.wanhai.com/cec/#/cargotracking?q=N', integration: 'blocked', integrationMessage: '提单号与柜号并行查询；任一路成功即可采用，两路成功时合并结果；HTTP 412 或页面验证会保留截图证据' },
  ...
  { prefix: 'YMJA', code: 'YANGMING', name: '阳明', removePrefix: false, queryMode: 'bill', url: 'https://www.yangming.com/en/esolution/cargo_tracking', integration: 'ready', integrationMessage: '已接入阳明官方 CargoTracking 公开接口；按提单号核对到港和柜号卸船事件' },
